...
function render() {
    ...
    for (let i = 0; i < abroadData.length; i++) {
        abroad.innerHTML += `<div class="card glass " style="width:27vw">
            <figure style="height: 350px;">
                <img src="${abroadData[i].image}" alt="${abroadData[i].judul
    ...
    for (let i = 0; i < localData.length; i++) {
        local.innerHTML += `<div class="card glass " style="width:27vw">
            <figure style="height: 350px;">
                <img src="${localData[i].image}" alt="${localData[i].judul
            }" style="height:100%; width: 100%;" />
            </figure>
            <div class="card-body ">
